...
# Design
###########################################################
read_netlist -top gcm_aes_core /scratch/CL120020/RevA0/gbarbiani/gcm_aes_core/synthesis/rc/results_Jul03-13:56:48/output/incremental/gcm_aes_core.v.gz

source /scratch/CL120020/RevA0/gbarbiani/gcm_aes_core/synthesis/rc/results_Jul03-13:56:48/output/incremental/gcm_aes_core.g.gz
...
if {$_cell_area_ != "104333"} {
   mesg_send [find -message /messages/PHYS/PHYS-92] "golden cell area: 104333,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "39462"} {
   mesg_send [find -message /messages/PHYS/PHYS-92] "golden net area: 39462,  current net area: $_net_area_"
}
unset _net_area_
